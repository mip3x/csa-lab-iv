...
Инструкций - 30, регистров - 16. Следовательно, опкод можно закодировать минимально в 5 битах, регистр - в 4 битах
...
Для операций ввода-вывода номер порта кодируется 10-битным значением (таким образом, доступно 1024 ВУ)
