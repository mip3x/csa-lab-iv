...
- **Цикл с постусловием**
    ...
    - **Описание**: выполнить набор инструкций из `<body>`, если после этого на вершине стека находится значение `истина`, то перейти к следующей итерации, иначе - выйти из цикла

- **Цикл с предусловием**
    - **Синтаксис**: `while <body#1> do <body#2> repeat`
    - **Описание**: если после выполнения набора инструкций из `<body#1>` на вершине стека находится значение `истина`, то выполнить набор инструкций из `<body#2>`, после чего перейти к следующей итерации, иначе - выйти из цикла
